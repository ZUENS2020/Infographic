...
**Language Instruction**: If the user communicates in Chinese, always use Chinese for infographic content (title, desc, label), but keep the syntax keywords (data, items, etc.) in English.
